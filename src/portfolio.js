...
const greeting = {  
  ...
  full_name: " Iheb Youssef",
  subTitle:
    "A Computer Science and Engineering student at ESPRIT with interest in software development especially web development .",
  resumeLink:
    "https://drive.google.com/file/d/1wrkG62HyDgbUOjNxexCT891tcqd83_cK/view?usp=sharing",
  mail: "youseef.iheb@gmail.com",
};

const socialMediaLinks = {
  /* Your Social Media Link */
  github: "https://github.com/iheeb9",
  linkedin: "https://www.linkedin.com/in/iheb-youssef-a82993240/",
  gmail: "youseef.iheb@gmail.com",
  // gitlab: "https://gitlab.com/harikanani",
  facebook: "https://www.facebook.com/hbambech/",
  twitter: "",
  instagram: "",
};
...
const degrees = {
  degrees: [
    {
      title: "Esprit",
      subtitle: "Private School of Engineering and Technology",
      logo_path: "esprit.png",
      alt_name: "Esprit",
      duration: "2020 - 2023",
      descriptions: [
        "⚡  I'm currently pursuing my National Diploma in Computer Engineering.",
    ...
    {
      title: "ISET",
      subtitle: "higher institute of technological studies of mahdia ",
      logo_path: "iset.png",
      alt_name: "ISET",
      duration: "2015 - 2020",
      descriptions: [
      ...
      website_link: "http://www.isetma.rnu.tn/",
      color_code: "#47A048",
    },
    {
      title: "Abou Kacem Chebbi Secondary School",
      subtitle: "baccalaureate",
      logo_path: "bac.png",
      alt_name: "SSEC",
      duration: "2015",
      descriptions: [
        "⚡  success in technical science baccalaureate .",
        // "⚡ I have studied core subjects like Data Structures, DBMS, Networking, Security, etc.",
        // "⚡ I have also completed various online courses for Backend , Web , Mobile App Development, etc.",
        // "⚡ I have implemented several projects based on what I've leart under my Computer Engineering course. ",
      ],
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of a vast variety of latest technology tools. My best experience is to create NodeJS/SpringBoot Backend Projects, Python Scripts, and React/Angular Project. Below are some of my projects. Note that not all of the mentioned projects are on GitHub yet.",
...
const projects = {
  data: [
    {
      id: "0",
      name: "Social Marketing & Emotions Detection",
      url: "https://github.com/iheeb9",
      description: "Offer for each seller a space to deposit his used products to sell Give access to customers to search, interpret and analyze consumers' emotional states based on verbal and paraverbal language",
      languages: [
        {
          name: "HTML5",
    ...
    },
    {
      ...
      url: "https://github.com/iheeb9",
      description:
        "a smart chatbot  that are programmed to answer questions. to measure consumer satisfaction rates ",
      languages: [
        {
        name: "HTML5",
        iconifyClass: "vscode-icons:file-type-html",
    ...
    },
    {
      ...
      url: "https://github.com/iheeb9",
      description:
        " build an E-Commerce website using SpringBoot/Angular  where users can add items, pay and order.",
    ...
    },
    {
      ...
      url: "https://github.com/iheeb9",
      description:
        "Smart Farm: a desktop application for manipulate and manage farm data",
      languages: [
        {
          name: "ubuntu",
    ...
    },
    {
      ...
      url:"https://github.com/iheeb9",
      description:
        "Sharing Prototype on facebook, Scrapping React,Comments and gettting reviews",
      languages: [
        {
          name: "Python",
          iconifyClass: "logos-python",
